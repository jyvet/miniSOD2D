...
contains
		...
		subroutine tet_4points(xgp,wgp)
			...
			xgp(1,1:3) = [0.58541020_rp, 0.13819660_rp, 0.13819660_rp]
			xgp(2,1:3) = [0.13819660_rp, 0.58541020_rp, 0.13819660_rp]
			xgp(3,1:3) = [0.13819660_rp, 0.13819660_rp, 0.58541020_rp]
			xgp(4,1:3) = [0.13819660_rp, 0.13819660_rp, 0.13819660_rp]
